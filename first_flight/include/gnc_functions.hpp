...
param1: Angletarget angle, 0 is northdeg
param2: Angular Speedangular speeddeg/s
param3: Directiondirection: -1: counter clockwise, 1: clockwisemin: -1 max:1 increment:2
param4: Relative0: absolute angle, 1: relative offsetmin:0 max:1 increment:1
@returns 0 for success
*/
